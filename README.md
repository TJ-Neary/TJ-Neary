...
**[Kendra-AI](https://github.com/TJ-Neary/Kendra-AI)** — Local-first personal AI system orchestrating voice interaction, four-tier semantic memory, and 26 automation skills through a privacy-first architecture on Apple Silicon. Three-layer design with deterministic table-driven routing, dual LLM backend (Claude CLI + Ollama), hybrid BM25+vector experiential memory with knowledge graph, and deep macOS integration. 3,863 tests across 107 files. Python 3.13 / Claude CLI / Ollama / React 19 / FastAPI / Mem0 / LanceDB.
